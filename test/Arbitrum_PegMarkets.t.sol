...
contract PegMarketsTest is Test {
    address assetWETH = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
    ...
    PegOracle stETH_Oracle;
    //address WETH = 0xEBbc3452Cc911591e4F18f3b36727Df45d6bd1f9;
    address stETH = 0xB1552C5e96B312d0Bf8b554186F846C40614a540;
    ...
    function setUp() public {
        ...
        //Arbitrum address of oracles
        stETH_Oracle = new PegOracle(0x07C5b924399cc23c24a95c8743DE4006a32b7f2a,0x639Fe6ab55C921f74e7fac1ee960C0B6293ba612);
    }
    ...
    function testCreatePegged() public {
        uint256 fee = 10;
        uint256 withdrawalFee = 50;
        int256 strikePrice = 100000000; //1$ = 100000000
        ...
        uint256 epochEnd2 = block.timestamp + 35 days; //Mon Aug 01 2022 23:00:00 GMT+0000
        CreationNewVaults(
            fee,
            withdrawalFee,
            stETH,
            ...
            epochBegin,
            epochEnd,
            address(stETH_Oracle),
            "Y2K.stETH"
        );

        emit log("Created new market");
    ...
    function testCreateMoreSTETH() public {
        uint256 fee = 10;
        uint256 withdrawalFee = 50;
        int256 strikePrice = 100000000; //1$ = 100000000
        uint256 epochBegin = block.timestamp + 2 days;
    ...
    function testMultipleUsersDepositsSTETH()
        public
        returns (
            uint256 ID,
            address _insr,
    ...
    function testMultipleEpochsDepositsSTETH() public {
        uint256 epochEnd = block.timestamp + 30 days;
        uint256 epochEnd2 = block.timestamp + 35 days;
    ...
    function testWithdrawMultipleUsersSTETH() public {
        (
            uint256 ID,
            address insr,
            address risk
        ) = testMultipleUsersDepositsSTETH();
    ...
    function testWithdrawMultipleUsersSTETHNODepeg() public {
        (
            uint256 ID,
            address insr,
            address risk
    ...
    function testOracle() public {
        ...
        int256 strikePrice = insrVault.strikePrice();
        emit log_named_int("Strike Price ", strikePrice);
        emit log_named_int("Latest Priced ", priceNow);

        emit log_named_int("Oracle 1 Price", stETH_Oracle.getOracle1_Price());
        emit log_named_int("Oracle 2 Price", stETH_Oracle.getOracle2_Price());
