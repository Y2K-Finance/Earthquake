...
export interface PriceFeedsManagerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addDataFeedIdAndUpdateValues" | "aggregateValues" | "getAuthorisedSignerIndex" | "getDataFeedsIds" | "getLastRound" | "getLastRoundParams" | "getLastUpdateTimestamp" | "getUniqueSignersThreshold" | "getValueForDataFeed" | "getValueForDataFeedAndLastRoundParams" | "getValuesForDataFeeds" | "lastRound" | "lastUpdateTimestampMilliseconds" | "owner" | "renounceOwnership" | "transferOwnership" | "updateDataFeedValues" | "validateTimestamp"): FunctionFragment;
...
export interface PriceFeedsManager extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PriceFeedsManagerInterface;
...
//# sourceMappingURL=PriceFeedsManager.d.ts.map