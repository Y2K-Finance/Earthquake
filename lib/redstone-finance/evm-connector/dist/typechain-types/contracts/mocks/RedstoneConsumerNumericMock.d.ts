...
export interface RedstoneConsumerNumericMockInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "aggregateValues" | "getAllMockAuthorised" | "getAllMockExceptLastOneAuthorised" | "getAuthorisedMockSignerIndex" | "getAuthorisedSignerIndex" | "getUniqueSignersThreshold" | "validateTimestamp"): FunctionFragment;
