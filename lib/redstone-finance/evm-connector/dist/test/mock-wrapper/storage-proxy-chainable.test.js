...
describe("SampleChainableStorageProxy", function () {
    ...
    this.beforeEach(async () => {
        const SampleChainableStorageFactory = await hardhat_1.ethers.getContractFactory("SampleChainableStorageProxy");
        contract = await SampleChainableStorageFactory.deploy();
        await contract.deployed();
        const SampleChainableStorageProxyConsumer = await hardhat_1.ethers.getContractFactory("SampleChainableStorageProxyConsumer");
...
//# sourceMappingURL=storage-proxy-chainable.test.js.map